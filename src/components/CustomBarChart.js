            ...
            <CustomTooltip>
                {dataKey === "attendancePercentage" ? (
                    <>
                        ...
                        <TooltipText>Présences : ({attendedClasses}/{totalClasses})</TooltipText>
                        <TooltipText>{attendancePercentage}%</TooltipText>
                    </>
                ) : (
                    <>
                        <TooltipMain>{subName.subName}</TooltipMain>
                        <TooltipText>Notes : {marksObtained}</TooltipText>
                    </>
                )}
            </CustomTooltip>
        );
...
// Fonction auxiliaire pour générer des couleurs distinctes
...
// Fonction auxiliaire pour convertir HSL en RGB
